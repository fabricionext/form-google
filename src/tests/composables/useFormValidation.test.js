...
describe('useFormValidation', () => {
  ...
  describe('Form Validation', () => {
    it('validates form successfully', async () => {
      ...
      const { validateForm, isFormValid } = useFormValidation(templateId, formData)
    ...
    it('handles validation errors', async () => {
      ...
      const { validateForm, validationErrors, isFormValid } = useFormValidation(templateId, formData)
    ...
    it('handles API errors gracefully', async () => {
      ...
      const { validateForm, validationErrors } = useFormValidation(templateId, formData)
  ...
  describe('Field Validation', () => {
    it('validates individual field', async () => {
      ...
      const { validateField, validationErrors } = useFormValidation(templateId, formData)
  ...
  describe('Client-side Validation', () => {
    ...
    it('validates minimum length', () => {
      ...
      const errors = validateFieldClient('nome', 'Jo', [{ type: 'minLength', params: 3 }])
    ...
    it('validates maximum length', () => {
      ...
      const errors = validateFieldClient('nome', 'Nome muito longo', [{ type: 'maxLength', params: 10 }])
  ...
  describe('Error Management', () => {
    it('clears all errors', () => {
      const { validationErrors, clearErrors } = useFormValidation(templateId, formData)
    ...
    it('clears specific field error', () => {
      const { validationErrors, clearFieldError } = useFormValidation(templateId, formData)
    ...
    it('sets field error', () => {
      const { validationErrors, setFieldError } = useFormValidation(templateId, formData)
    ...
    it('adds error to existing field errors', () => {
      const { validationErrors, addFieldError } = useFormValidation(templateId, formData)
  ...
  describe('Computed Properties', () => {
    it('calculates isFormValid correctly', () => {
      const { validationErrors, isFormValid } = useFormValidation(templateId, formData)
    ...
    it('calculates hasErrors correctly', () => {
      const { validationErrors, hasErrors } = useFormValidation(templateId, formData)
    ...
    it('calculates errorCount correctly', () => {
      const { validationErrors, errorCount } = useFormValidation(templateId, formData)
    ...
    it('gets field errors correctly', () => {
      const { validationErrors, getFieldErrors } = useFormValidation(templateId, formData)
    ...
    it('checks if field has error correctly', () => {
      const { validationErrors, hasFieldError } = useFormValidation(templateId, formData)
  ...
  describe('Validation Rules Loading', () => {
    it('loads validation rules for template', async () => {
      ...
      const { loadValidationRules, validationRules } = useFormValidation(templateId, formData)
