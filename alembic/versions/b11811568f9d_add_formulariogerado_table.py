...
def upgrade() -> None:
    ...
    # Removendo operações de DROP de tabelas que não existem
    # op.drop_table("posts")
    ...
    # Criar a nova tabela FormularioGerado
    op.create_table(
        "formulario_gerado",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("cliente_id", sa.Integer(), nullable=False),
        sa.Column("modelo_id", sa.Integer(), nullable=False),
        sa.Column("dados_preenchidos", sa.JSON(), nullable=False),
        sa.Column("status", sa.String(length=50), nullable=False),
        sa.Column("data_geracao", sa.DateTime(), nullable=False),
        sa.Column("data_envio", sa.DateTime(), nullable=True),
        sa.Column("observacoes", sa.Text(), nullable=True),
        sa.ForeignKeyConstraint(
            ["cliente_id"], ["clientes_peticionador.id"], name=op.f("fk_formulario_gerado_cliente_id_clientes_peticionador")
        ),
        sa.ForeignKeyConstraint(
            ["modelo_id"], ["peticao_modelos.id"], name=op.f("fk_formulario_gerado_modelo_id_peticao_modelos")
        ),
